...
4) Upon loading, the app should:
  ...
  4.2) Render those state variables to the page:
    4.2.1) Render the board:
      ...
      4.2.1.2) Use the index of the iteration to access the mapped value from the board array.
      4.3.1.3) Set the background color of the current element by using the value as a key on the colors lookup object (constant).
